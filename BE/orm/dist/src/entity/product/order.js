...
const infoUser_1 = require("../user/infoUser");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => infoUser_1.InfoUser, (infoUser) => infoUser.id),
    __metadata("design:type", infoUser_1.InfoUser)
], Order.prototype, "infoUser", void 0);
__decorate([
